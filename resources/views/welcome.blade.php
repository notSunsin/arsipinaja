...
<body>
        ...
        <div class="hero-container">
            ...
            <div class="hero-stats">
                <div class="stat-item">
                    ...
                    <div class="stat-label">Kelola Sistem, Master Data, Kelola Arsip & Laporan</div>
                    </div>
                <div class="stat-item">
                    <div class="stat-icon">
        ...
        <div class="section-container">
            ...
            <div class="features-grid">
                <div class="feature-card" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <p class="feature-desc">Buat arsip baru, lihat semua arsip, dan kelola arsip dengan mudah. Sistem kategori dan klasifikasi yang terstruktur.</p>
                    </div>
    ...
    <footer class="footer">
        ...
        <div class="footer-bottom">
            <p>&copy; 2026 ARSIPIN - DPMPTSP Provinsi Jawa Timur. Semua hak cipta dilindungi.</p>
        </div>
    </footer>
