                ...
                <div class="border-b border-gray-200 pb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="code" id="code"
                                class="w-full bg-white border border-gray-300 rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors py-3 px-4"
                                value="{{ old('code') }}" required placeholder="Contoh: 01.02.03">
                            @error('code')
                                <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="mt-6">
                        ...
                        <input type="text" name="nama_klasifikasi" id="nama_klasifikasi"
                            class="w-full bg-white border border-gray-300 rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors py-3 px-4"
                            value="{{ old('nama_klasifikasi') }}" required placeholder="Masukkan nama klasifikasi">
                    ...
                    <div>
                        ...
                        <div class="mt-3 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                            <p class="text-sm text-blue-700">
                                ...
                                <strong>Catatan:</strong> Nasib akhir menentukan apa yang terjadi dengan arsip setelah
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (form && submitBtn) {
                form.addEventListener('submit', function(e) {
                    ...
                    // Field validation
                    const requiredFields = ['category_id', 'code', 'nama_klasifikasi', 'retention_aktif',
                        'retention_inaktif', 'nasib_akhir'
                    ];
