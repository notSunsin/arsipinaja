<x-app-layout>
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600 mt-1">
                            <i class="fas fa-download mr-1"></i>Ekspor data arsip ke format Excel dengan filter periode
                        </p>
                    </div>
                </div>
    ...
    <div class="py-12">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <!-- Welcome Section -->
            <div class="bg-gradient-to-r from-blue-50 to-indigo-100 rounded-xl shadow-sm border border-blue-200 p-6 mb-8">
                <div class="flex items-center mb-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Export arsip dengan filter periode tahun</p>
                    </div>
                </div>
                ...
                <div class="flex items-center space-x-4 text-sm">
                    ...
                    <div class="flex items-center">
                        <i class="fas fa-crown mr-2 text-indigo-600"></i>
                ...
                @foreach($statuses as $key => $title)
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-lg transition-all duration-300 hover:border-blue-300">
                        ...
                        <div class="space-y-3">
                            ...
                            <a href="{{ route('admin.archives.export-form', $key) }}"
                               class="w-full inline-flex items-center justify-center px-4 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-medium rounded-lg transition-all shadow-lg hover:shadow-xl">
