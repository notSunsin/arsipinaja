        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 bg-white rounded-xl shadow-lg p-6">
                ...
                <div class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <!-- Total Musnah Archives -->
                    <div class="bg-gradient-to-r from-red-100 to-rose-100 rounded-lg p-4 border border-red-200">
                        <div class="flex items-center">
                            <div class="w-8 h-8 bg-red-500 rounded-lg flex items-center justify-center mr-3">
                                <i class="fas fa-ban text-white text-sm"></i>
                            </div>
                            <div>
                                <p class="text-sm font-medium text-red-800">Arsip Musnah</p>
                                <p class="text-xl font-bold text-red-900">{{ $myStatusDistribution['Musnah'] ?? 0 }}</p>
                            </div>
                        </div>
                    </div>
                </div>
