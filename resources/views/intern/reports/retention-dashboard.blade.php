                ...
                <div class="p-6">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex space-x-3">
                            <a href="{{ route('intern.reports.retention-dashboard', ['period' => 30]) }}"
                                class="px-4 py-2 text-sm font-medium rounded-md transition duration-200 {{ $period == 30 ? 'bg-orange-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200' }}">
                                30 Hari
                            </a>
                            <a href="{{ route('intern.reports.retention-dashboard', ['period' => 60]) }}"
                                class="px-4 py-2 text-sm font-medium rounded-md transition duration-200 {{ $period == 60 ? 'bg-orange-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200' }}">
                                60 Hari
                            </a>
                            <a href="{{ route('intern.reports.retention-dashboard', ['period' => 90]) }}"
                                class="px-4 py-2 text-sm font-medium rounded-md transition duration-200 {{ $period == 90 ? 'bg-orange-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200' }}">
                                90 Hari
                            </a>
                        </div>
                    </div>
