...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (DB::getDriverName() === 'mysql') {
            ...
            DB::statement("ALTER TABLE classifications MODIFY COLUMN nasib_akhir ENUM('Musnah','Permanen','Dinilai Kembali','Masuk ke Berkas Perseorangan') NOT NULL DEFAULT 'Permanen'");
        } else {
    ...
    public function down(): void
    {
        ...
        if (DB::getDriverName() === 'mysql') {
            ...
            DB::statement("ALTER TABLE classifications MODIFY COLUMN nasib_akhir ENUM('Musnah','Permanen','Dinilai Kembali') NOT NULL DEFAULT 'Permanen'");
        } else {
            DB::statement("ALTER TABLE classifications DROP CONSTRAINT IF EXISTS classifications_nasib_akhir_check");
        }
